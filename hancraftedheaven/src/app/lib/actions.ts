...
const mapProductToProductWithSeller = (p: any): ProductWithSeller => ({
  ...p,
  price: p.price.toNumber(), // Convertir Decimal a number
  seller_firstname: p.seller.firstname,
  seller_lastname: p.seller.lastname,
  seller_category: p.seller.profile!.category,
});
